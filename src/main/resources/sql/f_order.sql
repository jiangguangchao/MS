create table if not exists f_order(
    ...
    frontMoneyTime timestamp default CURRENT_TIMESTAMP comment '定金支付时间',
    payTime timestamp default CURRENT_TIMESTAMP comment '余款支付时间',
    deliverTime timestamp default CURRENT_TIMESTAMP comment '送货时间',
    state enum('1','2','3','4'),
